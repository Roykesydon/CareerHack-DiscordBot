...
import json
from prompt_templates import TOOL_DESCRIPTION, REACT_PROMPT_TEMPLATE
...
def generate_planning_prompt(tools, user_query):
    ...
    prompt = REACT_PROMPT_TEMPLATE.format(tool_descs=combined_descriptions, tool_names=combined_tool_names, query=user_query)
    return prompt
